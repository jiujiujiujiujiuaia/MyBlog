...
<div class="container custome-container">
    <nav class="breadcrumb">
        ...
        <a href="${config.siteUrl}/type/${article.typeId}" title="点击查看该分类文章" data-toggle="tooltip" data-placement="bottom">${article.typeName}</a>
        ...
        <div class="col-sm-8 blog-main">
            <div class="blog-body overflow-initial fade-in">
                ...
                <div class="blog-info overflow-initial">
                    ...
                    <div class="article-footer overflow-initial">所属分类：<a href="${config.siteUrl}/type/${article.typeId}" data-original-title="点击查看${article.typeName}分类的文章" data-toggle="tooltip" data-placement="bottom">${article.typeName}</a></div>
                </div>
            </div>
            <#--<div class="blog-body">-->
